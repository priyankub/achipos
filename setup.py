...
if platform.system() == "Windows":
    setup(
        ...
        description="Achi proof of space plotting, proving, and verifying (wraps C++)",
        license="Apache License",
        python_requires=">=3.7",
        long_description=open("README.md").read(),
        long_description_content_type="text/markdown",
        url="https://github.com/Achi-Coin/achipos",
    ...
    setup(
        ...
        long_description_content_type="text/markdown",
        url="https://github.com/Achi-Coin/achipos",
        ext_modules=[CMakeExtension("achipos", ".")],
