...
running ./ProofOfSpace from the C++ binary build of achipos. It assumes
you are in the achipos/build directory. If plotting large plots you should
ln -s a temp and final directory into achipos/build/plots.
